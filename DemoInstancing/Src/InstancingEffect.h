#ifndef _INSTANCINGEFFECT_H_
#define _INSTANCINGEFFECT_H_

#include "Effect.h"
#include "d3dApp.h"
#include "UnknownInstance\UnknownInstance.h"

class InstancingEffect : public Effect,public UnknownInstance<InstancingEffect>
{
public:
	InstancingEffect(ID3D11Device* device, const std::wstring& filename);
