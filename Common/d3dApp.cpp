...
D3DApp* D3DApp::smInstance = nullptr;
...
void D3DApp::UpdateScene(float dt)
{
	if( mCurCameraCtrl )
	{
		mCurCameraCtrl->UpdateCamera(mCamera);
	}
...
LRESULT D3DApp::MsgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MBUTTONDOWN:
	case WM_RBUTTONDOWN:
		mEvtOnMouseDown.Invoke(wParam, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		return 0;
	case WM_LBUTTONUP:
	case WM_MBUTTONUP:
	case WM_RBUTTONUP:
		mEvtOnMouseUp.Invoke(wParam, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		return 0;
	case WM_MOUSEMOVE:
		mEvtOnMouseMove.Invoke(wParam, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		return 0;
	}
