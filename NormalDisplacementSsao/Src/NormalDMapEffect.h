#ifndef _NORMALMAPEFFECT_H_
#define _NORMALMAPEFFECT_H_
...
class NormalMapEffect : public Effect, public UnknownInstance<NormalMapEffect>
{
public:
...
class DisplacementMapEffect : public Effect, public UnknownInstance<DisplacementMapEffect>
{
public:
