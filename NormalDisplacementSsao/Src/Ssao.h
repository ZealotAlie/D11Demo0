...
public:
	...
	void Build(D3DApp* pApp);

	///<summary>
	/// Call when the backbuffer is resized.  
	///</summary>
	void OnSize(D3DApp* pApp);
	...
	///</summary>
	void SetNormalDepthRenderTarget(ID3D11DeviceContext* pContext,ID3D11DepthStencilView* dsv);
...
private:
	...
	void BuildFullScreenQuad(ID3D11Device *pDevice);

	void BuildTextureViews(ID3D11Device *pDevice);
